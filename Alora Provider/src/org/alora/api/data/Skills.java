...
public enum Skills {
    ...
    private int[] getSkillExpArray() {
        return (int[]) Loader.getReflectionEngine().getFieldValue("OG", "LZ", null);
    }

    private int[] getSkillLevelArray() {
        return (int[]) Loader.getReflectionEngine().getFieldValue("OG", "MZ", null);
    }

    private int[] getRealSkillLevelArray() {
        return (int[]) Loader.getReflectionEngine().getFieldValue("OG", "KZ", null);
    }
